import{m as L,n as R,o as b,p as T,_ as d,q as $,t as p,r as N,v as S,w as U,j as i,x as A,y as M,f as P,L as x,z as X}from"./index-2b4c00f8.js";function F(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function B(t){return parseFloat(t)}function E(t){return L("MuiSkeleton",t)}R("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const K=["animation","className","component","height","style","variant","width"];let h=t=>t,C,v,k,f;const W=t=>{const{classes:n,variant:a,animation:o,hasChildren:s,width:c,height:l}=t;return M({root:["root",a,o,s&&"withChildren",s&&!c&&"fitContent",s&&!l&&"heightAuto"]},E,n)},q=b(C||(C=h`
  0% {
    opacity: 1;
  }
